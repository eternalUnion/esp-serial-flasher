...
{
    gpio_set_level((gpio_num_t)s_gpio0_trigger_pin, 0);
    loader_port_reset_target();
    loader_port_delay_ms(50);
    gpio_set_level((gpio_num_t)s_gpio0_trigger_pin, 1);
}


void loader_port_reset_target(void)
{
    gpio_set_level((gpio_num_t)s_reset_trigger_pin, 0);
    loader_port_delay_ms(50);
    gpio_set_level((gpio_num_t)s_reset_trigger_pin, 1);
}
